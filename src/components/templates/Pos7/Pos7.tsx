        ...
        <>
            ...
            >
                ...
                <div className='absolute z-10 m-auto flex h-full w-full flex-col items-stretch justify-between text-center text-white'>
                    <div />
                    <p className='px-0 pb-2 font-acumin text-[14px] italic'>
                        {Math.floor(
                    ...
                    <p className='flex h-[25%] items-center justify-center px-2 pb-4 text-center font-lucette text-[14px] italic'>
                    ...
                    <div className='flex w-full flex-col gap-8 md:w-[40%]'>
                        ...
                        >
                            ...
                            <p className='text-center font-acumin'>
                                ...
                                @idcbinusbandung @binuslibrarybdg
                                @pulitzercenter
                            </p>
                            <div
